...
GITHUB_ASSETS_REPO = "Object Detection_yolo/assets"
GITHUB_ASSETS_NAMES = (
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=(".DS_Store", "__MACOSX"), progress=True):
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=(".DS_Store", "__MACOSX"), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.downloads import unzip_file
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.downloads import get_google_drive_file_info
...
def safe_download(
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.downloads import safe_download
...
def get_github_assets(repo="Object Detection_yolo/assets", version="latest", retry=False):
    """
    Retrieve the specified version's tag and assets from a GitHub repository. If the version is not specified, the
    function fetches the latest release assets.

    Args:
        repo (str, optional): The GitHub repository in the format 'owner/repo'. Defaults to 'Object Detection_yolo/assets'.
    ...
    Example:
        ```python
        tag, assets = get_github_assets(repo='Object Detection_yolo/assets', version='latest')
        ```
    """
...
def attempt_download_asset(file, repo="Object Detection_yolo/assets", release="v8.2.0", **kwargs):
    """
    ...
    Example:
        ```python
        file_path = attempt_download_asset('yolov8n.pt', repo='Object Detection_yolo/assets', release='latest')
        ```
    """
