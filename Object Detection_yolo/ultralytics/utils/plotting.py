...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    ...
    import pandas  # scope for faster 'import Object Detection_yolo'
    import seaborn  # scope for faster 'import Object Detection_yolo'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.plotting import save_one_box
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.plotting import plot_results

        plot_results('path/to/results.csv', segment=True)
        ```
    """
    import pandas as pd  # scope for faster 'import Object Detection_yolo'
