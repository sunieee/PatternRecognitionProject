...
Usage:
    from Object Detection_yolo.utils.benchmarks import ProfileModels, benchmark
...
def benchmark(
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.benchmarks import benchmark
...
class RF100Benchmark:
    ...
    def parse_dataset(self, ds_link_txt="datasets_links.txt"):
        ...
        os.chdir("rf-100")
        os.mkdir("Object Detection_yolo-benchmarks")
...
class ProfileModels:
    ...
    Example:
        ```python
        from Object Detection_yolo.utils.benchmarks import ProfileModels
