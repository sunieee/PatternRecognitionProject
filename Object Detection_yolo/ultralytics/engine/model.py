...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[Object Detection_yolo.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (Object Detection_yolo.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (Object Detection_yolo.engine.model.Model): The instance of the class with loaded weights.
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("Object Detection_yolo")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[Object Detection_yolo.engine.results.Results]): A list of tracking results, encapsulated in the Results class.
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the Object Detection_yolo.utils.benchmarks module. The benchmarking is configured
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the Object Detection_yolo.utils.tuner module.
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the Object Detection_yolo.nn.autobackend module.
