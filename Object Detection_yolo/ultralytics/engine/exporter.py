...
Requirements:
    $ pip install "Object Detection_yolo[export]"
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/Object Detection_yolo/Object Detection_yolo/pull/13420
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        if int8:
            ...
            class EngineCalibrator(trt.IInt8Calibrator):
                def __init__(
                    self,
                    dataset,  # Object Detection_yolo.data.build.InfiniteDataLoader
                    batch: int,
                    cache: str = "",
                ) -> None:
