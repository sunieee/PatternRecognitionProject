...
```bash
conda create --name Object Detection_yolo-env python=3.8 -y
```

Activate the new environment:

```bash
conda activate Object Detection_yolo-env
```
...
```bash
conda install -c conda-forge Object Detection_yolo
```
...
```bash
conda install -c pytorch -c nvidia -c conda-forge pytorch torchvision pytorch-cuda=11.8 Object Detection_yolo
```
...
t=Object Detection_yolo/Object Detection_yolo:latest-conda
