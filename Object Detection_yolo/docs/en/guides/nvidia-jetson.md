...
```bash
t=Object Detection_yolo/Object Detection_yolo:latest-jetson-jp5 && sudo docker pull $t && sudo docker run -it --ipc=host --runtime=nvidia $t
```
...
```bash
t=Object Detection_yolo/Object Detection_yolo:jetson-jp4 && sudo docker pull $t && sudo docker run -it --ipc=host --runtime=nvidia $t
```
