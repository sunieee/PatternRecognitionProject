...
"""
Helper file to build Ultralytics Docs reference section. Recursively walks through Object Detection_yolo dir and builds an MkDocs
...
if hub_sdk:
    ...
    GITHUB_REPO = "Object Detection_yolo/hub-sdk"
else:
    FILE = Path(__file__).resolve()
    PACKAGE_DIR = FILE.parents[1] / "Object Detection_yolo"  # i.e. /Users/glennjocher/PycharmProjects/Object Detection_yolo/Object Detection_yolo
    REFERENCE_DIR = PACKAGE_DIR.parent / "docs/en/reference"
    GITHUB_REPO = "Object Detection_yolo/Object Detection_yolo"
